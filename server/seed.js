...
async function main() {
    const uri = "mongodb+srv://phananh26082001:26082001Anh@cluster0.i88xji7.mongodb.net/thuc-tap-tot-nghiep?retryWrites=true&w=majority";
    const client = new MongoClient(uri);

    try {
        await client.connect();

        const productsCollection = client.db("thuc-tap-tot-nghiep").collection("products");
        const categoriesCollection = client.db("thuc-tap-tot-nghiep").collection("categories");
